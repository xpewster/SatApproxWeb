...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26384_SHARP_){
return html_coll.item(p1__26384_SHARP_);
...
return cljs.core.some((function (p1__26389_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__26389_SHARP_);
...
var ctx_26403 = cvs.getContext("2d");
(ctx_26403.fillStyle = color);

ctx_26403.fillRect((0),(0),size,size);
