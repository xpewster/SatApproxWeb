...
var node = (function (){var G__26512 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__26513 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__26514 = style_string_26618;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__26512,G__26513,G__26514) : cljs_test_display.core.n.call(null,G__26512,G__26513,G__26514));
})();
...
var i__4819__auto___26620 = (0);
while(true){
if((i__4819__auto___26620 < len__4818__auto___26619)){
args__4824__auto__.push((arguments[i__4819__auto___26620]));

var G__26621 = (i__4819__auto___26620 + (1));
i__4819__auto___26620 = G__26621;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq26521){
var G__26526 = cljs.core.first(seq26521);
var seq26521__$1 = cljs.core.next(seq26521);
var G__26527 = cljs.core.first(seq26521__$1);
var seq26521__$2 = cljs.core.next(seq26521__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26526,G__26527,seq26521__$2);
}));
...
var vec__26532 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26532,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26532,(1),null);
var G__26535 = cljs.core.PersistentArrayMap.EMPTY;
var G__26535__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26535,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26535);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26535__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__26535__$1;
}
} else {
...
return (function() { 
var G__26622__delegate = function (klass,contents){
var vec__26536 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26536,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26536,(1),null);
...
var G__26622 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__26623__i = 0, G__26623__a = new Array(arguments.length -  1);
while (G__26623__i < G__26623__a.length) {G__26623__a[G__26623__i] = arguments[G__26623__i + 1]; ++G__26623__i;}
  contents = new cljs.core.IndexedSeq(G__26623__a,0,null);
} 
return G__26622__delegate.call(this,klass,contents);};
G__26622.cljs$lang$maxFixedArity = 1;
G__26622.cljs$lang$applyTo = (function (arglist__26624){
var klass = cljs.core.first(arglist__26624);
var contents = cljs.core.rest(arglist__26624);
return G__26622__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__26556){
var map__26557 = p__26556;
var map__26557__$1 = cljs.core.__destructure_map(map__26557);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26557__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26557__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__26581){
var map__26583 = p__26581;
var map__26583__$1 = cljs.core.__destructure_map(map__26583);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26583__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26583__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__26603){
var map__26604 = p__26603;
var map__26604__$1 = cljs.core.__destructure_map(map__26604);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26604__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26604__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__26605_SHARP_){
return cljs.core.cons(new_current_node,p1__26605_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__26610 = cljs_test_display.core.current_var_info();
var map__26610__$1 = cljs.core.__destructure_map(map__26610);
var info = map__26610__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26610__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26610__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26610__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__26609_SHARP_){
return cljs.core.cons(node,p1__26609_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__26612){
var map__26613 = p__26612;
var map__26613__$1 = cljs.core.__destructure_map(map__26613);
var m = map__26613__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26613__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26613__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26613__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26613__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__26614 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__26614) : formatter_fn.call(null,G__26614));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__26615 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__26615) : formatter_fn.call(null,G__26615));
})()], 0));
});
...
var temp__5753__auto___26626 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___26626)){
var message_26627 = temp__5753__auto___26626;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_26627], 0));
} else {
}
...
var temp__5753__auto___26628 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___26628)){
var message_26629 = temp__5753__auto___26628;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_26629], 0));
} else {
}
