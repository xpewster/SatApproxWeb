...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33103 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33103(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33111 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33111(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_33118 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_33118(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33119 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33119(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33126 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33126(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33127 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33127(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33089,callback){
var map__33090 = p__33089;
var map__33090__$1 = cljs.core.__destructure_map(map__33090);
var input = map__33090__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33090__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33090__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
